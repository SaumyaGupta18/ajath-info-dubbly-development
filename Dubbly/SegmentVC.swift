...
//
//    var slides: [String] = [] // Array to store slide data
//
//    override func viewDidLoad() {
//        super.viewDidLoad()
//
...
//
//        // Configure the cell with slide content
//        // For simplicity, just set the text label to slide number
//        let label = UILabel(frame: cell.contentView.bounds)
//        label.textAlignment = .center
//        label.text = slides[indexPath.item]
...
//    // MARK: Actions
//
//    @IBAction func addSlide(_ sender: UIButton? = nil) {
//        // Add a new slide to the data source
//        let newSlide = "Slide \(slides.count + 1)"
//        slides.append(newSlide)
//
//        // Insert the new item in the collection view
//        let newIndexPath = IndexPath(item: slides.count - 1, section: 0)
//        collectionView.insertItems(at: [newIndexPath])
//
//        // Optionally, scroll to the newly added slide

...
class ProfileVC: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    let language = [["AF": ["Afghanistan","93"]],
    ...
    override func viewDidLoad() {
        ...
        viewProfile.layer.borderWidth = 2.0
        ...
        emailTxtField.layer.borderWidth = 2.0
        emailTxtField.layer.borderColor = UIColor.clear.cgColor
        emailTxtField?.setPadding(left: padding)
        
        nameTxtField.layer.cornerRadius = 8.0
        nameTxtField.layer.borderWidth = 2.0
        nameTxtField.layer.borderColor = UIColor.clear.cgColor
        nameTxtField?.setPadding(left: padding)
        
        languageTextfield.layer.cornerRadius = 8.0
        languageTextfield.layer.borderWidth = 2.0
        languageTextfield.layer.borderColor = UIColor.clear.cgColor
        languageTextfield?.setPadding(left: padding)
        
        mobileTxtField.layer.cornerRadius = 8.0
        mobileTxtField.layer.borderWidth = 2.0
        mobileTxtField.layer.borderColor = UIColor.clear.cgColor
        mobileTxtField?.setPadding(left: padding)
        
        codeTxtField.layer.cornerRadius = 8.0
        codeTxtField.layer.borderWidth = 2.0
        codeTxtField.layer.borderColor = UIColor.clear.cgColor
        ...
        codeTxtField.inputAccessoryView = toolbar
    }
    
    @objc func doneBtn() {
        languageTextfield.resignFirstResponder()
        codeTxtField.resignFirstResponder()
    }
...
extension ProfileVC : UIPickerViewDelegate,  UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        selectedLanguage = countries[row]
//        selectCountrycode = language[row]
        languageTextfield.text = selectedLanguage
        codeTxtField.text = selectCountrycode
    }
